<template>
  <article class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="prose prose-lg dark:prose-invert max-w-none">
      ...
      <p>
        生成AIへの指示は<strong>「制約を与える」</strong>行為です。単に「できないこと」を増やすのではなく、「この方向に進んでほしい」という道筋を示すこと。生成AIは、自身が生成できる無数の可能性から、与えられた制約に最も適合するものを選び出して返します。
      </p>
      ...
      <p>
        さらに言えば、2025年末の時点で、生成AIが具体的なタスクをこなす能力はすでにほとんどの人間を超えています。つまり、制約を過剰に増やすよりも、AIに任せた方が品質が高まるケースが多いのです。
      </p>
      ...
      <p>
        AIが進化しても、この力の重要性は変わりません。幹を見つける、幹を渡す、幹を蓄積する、幹を見極める——フェーズは変わっても、幹を理解している人間が価値を生み出す構造は同じです。
      </p>
